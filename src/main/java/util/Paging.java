...
public class Paging {
	public static String getPaging(String pageURL, int nowPage, int rowTotal, int blockList, int blockPage) {
		...
		if (isPrevPage) {
			...
			sb.append("<li class='desabled'><a href='#'>◀</a></li>");
	...
	public static String getPaging1(String pageURL, String search_filter, int nowPage, int rowTotal, int blockList,
			int blockPage, int b_idx) {
		...
		// --------------------------------------------------------------------------------------------
		if (isPrevPage) {
			sb.append("<li><a href ='" + pageURL + "?b_idx=");
			sb.append(b_idx);
			sb.append("&");
			sb.append("page=");
			sb.append(startPage - 1);
	...
	// 댓글
	public static String getPaging1(String pageURL, int nowPage, int rowTotal, int blockList, int blockPage) {
		...
		if (isPrevPage) {
			...
			sb.append("<li class='desabled'><a href='#c_menu'>◀</a></li>");
		...
		for (int i = startPage; i <= endPage; i++) {
			// if(i>totalPage)break;
			if (i == nowPage) { // 현재 있는 페이지
				sb.append("<li class='active'><a href='#c_menu'>");
				sb.append(i);
				sb.append("</a></li>");
			} else {// 현재 페이지가 아니면
				sb.append("<li><a href='#c_menu' onclick='comment_list(");
			...
			// <li><a href='#c_menu' onclick="comment_list(
			// 2
			// );">
			// 2
			// </a></li>
			// <li><a href='list.do?page=
			// 1
			// '>
			// 1
			// </a></li>
