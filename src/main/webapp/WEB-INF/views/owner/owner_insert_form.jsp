...
<body>
  ...
  <form class="form-inline" id="createform" name="form1" method="POST">
    ...
    <input type="text" name="o_name" id="o_name" placeholder="이름">
    <input type="text" name="o_email" id="o_email" placeholder="이메일">
    <input type="text" name="o_id" id="o_id" placeholder="아이디">
    <input type="password" name="o_pwd" id="o_pwd" placeholder="비밀번호">
    <input type="text" name="o_addr" id="o_addr" placeholder="주소">
    <input type="text" name="o_add_addr" id="o_add_addr" placeholder="나머지 주소">
    <input type="text" name="o_tel" id="o_tel" placeholder="전화번호">
    <input type="text" name="o_storee" id="o_storee" placeholder="가게이름">
